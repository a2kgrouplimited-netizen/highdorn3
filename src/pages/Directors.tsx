        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {directors.map((director, index) => (
              ...
              >
                {/* Updated the text color for the name to light blue */}
                <h3 className="text-2xl font-bold mb-2" style={{ color: 'rgb(56, 155, 247)' }}>
                  {director.name}
                </h3>
                {/* Updated the text color for the position to a lighter navy blue */}
                <p className="font-semibold mb-4" style={{ color: '#1a2b4a' }}>
                  {director.position}
                </p>
