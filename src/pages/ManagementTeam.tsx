    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 pt-20 font-sans">
      ...
      <section className="py-20" style={{ backgroundColor: '#0f172a' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-5xl font-bold mb-6 text-white">Management Team</h1>
            ...
            {managers.map((manager, index) => (
              ...
              >
                <div className="p-6 flex-grow"> {/* flex-grow to make bio section expand */}
                  ...
                  <p className="text-teal-600 dark:text-teal-400 font-medium text-lg mb-4">
                    {manager.position}
                  </p>
                  
                  <div className="flex items-center gap-4 mb-4 text-sm">
                    <span className="bg-teal-100 dark:bg-teal-900 text-teal-800 dark:text-teal-200 px-2 py-1 rounded-full text-xs font-semibold">
